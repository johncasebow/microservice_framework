...
public class DefaultDispatcherCacheTest {
    ...
    private DefaultDispatcherCache dispatcherCache = new DefaultDispatcherCache();

    @Before
    public void setUp() throws Exception {
        dispatcherCache = new DefaultDispatcherCache();
